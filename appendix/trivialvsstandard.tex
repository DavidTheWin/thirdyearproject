...
\begin{center}
\input{graphs/trivialvsstandardconversiontimegraph.tex}
\end{center}

\begin{center}
\input{graphs/standarddurationovertrivialdurationgraph.tex}
\end{center}

\begin{center}
\input{graphs/trivialvsstandardconversionsizegraph.tex}
\end{center}

\begin{center}
\input{graphs/trivialsizeoverstandardsizegraph.tex}
\end{center}
